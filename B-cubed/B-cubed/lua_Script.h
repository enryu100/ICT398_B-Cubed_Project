...
public:
    ...
    */
	lua_Script(void);
		/**
    *@brief default deconstructer for lua_script
    */
	~lua_Script(void);
		/**
    ...
    *@return string
		*@param varName - const char*
    */
	std::string Read_Variable_String(const char* varName);
		/**
    *@brief Reads in a float from a lua file
    *@return float
		*@param varName - const char*
    */
	float Read_Variable_Float(const char* varName);
private:
	lua_State*L;
